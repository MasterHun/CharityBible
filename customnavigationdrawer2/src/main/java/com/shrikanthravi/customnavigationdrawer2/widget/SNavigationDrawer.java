...
public class SNavigationDrawer extends RelativeLayout{
    ...
    private int menuItemSemiTransparentColorSub = R.color.transparent_black_percent_60;
    ...
    private int primaryMenuItemTextColorSub = R.color.White;
    private int secondaryMenuItemTextColor = getResources().getColor(R.color.Black);
    private int secondaryMenuItemTextColorSub = R.color.Black;
    ...
    protected void setAttributes(TypedArray attrs){
        ...
        setMenuItemSemiTransparentColor(attrs.getColor(R.styleable.SNavigationDrawer_HamMenuItemSemiTransparentColor,getResources().getColor(menuItemSemiTransparentColorSub)));
        ...
        setPrimaryMenuItemTextColor(attrs.getColor(R.styleable.SNavigationDrawer_navigationDrawerBackgroundColor,getResources().getColor(primaryMenuItemTextColorSub)));
        setSecondaryMenuItemTextColor(attrs.getColor(R.styleable.SNavigationDrawer_secondaryMenuItemTextColor,getResources().getColor(secondaryMenuItemTextColorSub)));
