...
public class VerseListAdapter extends BaseAdapter {
    ...
    public void addItem(String number, String verse) {
        ListViewItem item = new ListViewItem();

        item.setStrNumber(number);
        item.setStrVerse(verse);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.verselist_item, parent, false);
        }
        ...
        // 아이템 내 각 위젯에 데이터 반영
        textNumber.setText(listViewItem.getStrNumber());
